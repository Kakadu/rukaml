...
let mtx_mul_3x3 a b =
  ...
  [| [| (array_get a0 0 * array_get b0 0)
        + (array_get a0 1 * array_get b1 0)
        + (array_get a0 2 * array_get b2 0)
      ; (array_get a0 0 * array_get b0 1)
        + (array_get a0 1 * array_get b1 1)
        + (array_get a0 2 * array_get b2 1)
      ; (array_get a0 0 * array_get b0 2)
        + (array_get a0 1 * array_get b1 2)
        + (array_get a0 2 * array_get b2 2)
     |]
   ; [| (array_get a1 0 * array_get b0 0)
        + (array_get a1 1 * array_get b1 0)
        + (array_get a1 2 * array_get b2 0)
      ; (array_get a1 0 * array_get b0 1)
        + (array_get a1 1 * array_get b1 1)
        + (array_get a1 2 * array_get b2 1)
      ; (array_get a1 0 * array_get b0 2)
        + (array_get a1 1 * array_get b1 2)
        + (array_get a1 2 * array_get b2 2)
     |]
   ; [| (array_get a2 0 * array_get b0 0)
        + (array_get a2 1 * array_get b1 0)
        + (array_get a2 2 * array_get b2 0)
      ; (array_get a2 0 * array_get b0 1)
        + (array_get a2 1 * array_get b1 1)
        + (array_get a2 2 * array_get b2 1)
      ; (array_get a2 0 * array_get b0 2)
        + (array_get a2 1 * array_get b1 2)
        + (array_get a2 2 * array_get b2 2)
     |]
  |]
;;
