  ...
  let main = let rec aux n k1 = if n = 0 then k1 (fun st k2 -> k2 ((), st + 1)) 
                                         else if n = 1 then k1 (fun st k3 ->
                                                                k3 ((), st + 1))
                                                            else aux (n - 2) 
                                                                 (fun t4 ->
                                                                  aux (n - 1) 
  ...
  After CPS optimisations.
  let main = let rec aux n e10 k1 = if n = 0 then k1 ((), e10 + 1) else 
                                                                   if n = 1 
                                                                   then 
                                                                   k1 ((), e10 + 1)
                                                                   else 
