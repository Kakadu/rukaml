  $ ../../back/rv64/RV64_compiler.exe -o program.s --no-start -danf fac_acc.ml
  ...
  $ riscv64-linux-gnu-gcc-13 -g program.o ../../back/rv64/rukaml_stdlib.o -o fac_acc.exe 2>&1 | head -n5
