  ...
  $ cat program.s | grep -v 'section .note.GNU-stack' | nl -ba
       1	.globl fac
       2	fac:
       3	  addi sp, sp, -(8*4) # allocate for local variables temp5, p1, n1, temp1
       4	 # 40(sp), find_exn "n" = -1, last_pos = 4  
       5	  ld t0, 40(sp) # locals = 4
       6	  li t1, 2
       7	  blt t0, t1, lab_10
       8	  sd zero, 24(sp)
       9	  beq zero, zero, lab_11 # Where is unconditional jump?
      10	lab_10:
      11	  li t0, 1 # (* RISC is weird *)
      12	  sd t0, 24(sp) # dest = 24(sp)
      13	  beq zero, zero, lab_11 # not needed?
      14	lab_11:
      15	  ld  t0, 24(sp)
      ...
      63	lab_endif_13:
      64	  addi sp, sp, 8*4 # deallocate local variables temp5, p1, n1, temp1
      65	  ret  # fac
      66	.globl main
      67	main:
      68	  addi sp, sp, -(8*3) # allocate for local variables g, f, temp7
     ...
     109	  li a0, 0
     110	  addi sp, sp, 8*3 # deallocate local variables g, f, temp7
