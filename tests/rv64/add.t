  ...
  $ cat program.s | grep -v 'section .note.GNU-stack' | nl -ba
      ...
      11	.globl main
      12	main:
      13	  addi sp, sp, -(8*3) # allocate for local variables y, x, temp2
      ...
      54	  li a0, 0
      55	  addi sp, sp, 8*3 # deallocate local variables y, x, temp2
