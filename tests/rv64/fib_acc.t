  ...
  $ cat program.s | grep -v 'section .note.GNU-stack' | nl -ba
       1	.globl fib_acc
       2	fib_acc:
       3	  addi sp, sp, -(8*5) # allocate for local variables temp6, temp5, ab, n1, temp1
       4	 # 56(sp), find_exn "n" = -2, last_pos = 5  
       5	  ld t0, 56(sp) # locals = 5
       6	  li t1, 1
       7	  beq t0, t1, lab_12
       8	  sd zero, 32(sp)
       9	  beq zero, zero, lab_13 # Where is unconditional jump?
      10	lab_12:
      11	  li t0, 1 # (* RISC is weird *)
      12	  sd t0, 32(sp) # dest = 32(sp)
      13	  beq zero, zero, lab_13 # not needed?
      14	lab_13:
      15	  ld  t0, 32(sp)
      ...
      76	lab_endif_15:
      77	  addi sp, sp, 8*5 # deallocate local variables temp6, temp5, ab, n1, temp1
      78	  ret  # fib_acc
      79	.globl main
      80	main:
      81	  addi sp, sp, -(8*4) # allocate for local variables g, f, temp9, temp8
     ...
     135	  li a0, 0
     136	  addi sp, sp, 8*4 # deallocate local variables g, f, temp9, temp8
