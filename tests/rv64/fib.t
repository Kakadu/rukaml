  ...
  $ cat program.s | grep -v 'section .note.GNU-stack' | nl -ba
       1	.globl fib
       2	fib:
       3	  addi sp, sp, -(8*5) # allocate for local variables p2, temp5, p1, temp3, temp
      ...
      29	  sd ra, 8(sp)
      30	  call fib
      31	  addi sp, sp, 8*1 # deallocate 1 args
      32	  ld ra, (sp)
      ...
      43	  sd ra, 8(sp)
      44	  call fib
      45	  addi sp, sp, 8*1 # deallocate 1 args
      46	  ld ra, (sp)
      ...
      55	  addi a0, t5, 0
      56	lab_endif_13:
      57	  addi sp, sp, 8*5 # deallocate local variables p2, temp5, p1, temp3, temp
      58	  ret  # fib
      59	.globl main
      60	main:
      61	  addi sp, sp, -(8*2) # allocate for local variables g, f
      ...
      67	  sd ra, 8(sp)
      68	  call fib
      69	  addi sp, sp, 8*1 # deallocate 1 args
      70	  ld ra, (sp)
      ...
      80	  li a0, 0
      81	  addi sp, sp, 8*2 # deallocate local variables g, f
