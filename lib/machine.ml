...
type instr =
  ...
  | J of string (* Jump. Corresponds to JAL x0, label *)
  | Label of string
  | Comment of string
...
let pp_instr ppf =
  ...
  | Bge (r1, r2, offset) ->
      fprintf ppf "bge %a, %a, %s" pp_reg r1 pp_reg r2 offset
  | Bne (r1, r2, offset) ->
      fprintf ppf "bne %a, %a, %s" pp_reg r1 pp_reg r2 offset
  | Blt (r1, r2, offset) ->
...
let bge k r1 r2 r3 = k @@ Bge (r1, r2, r3)
